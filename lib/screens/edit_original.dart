                                              ...
                                              child: Directionality(
                                                ...
                                                child: TextFormField(
                                                  ...
                                                  onSaved: (value){
                                                    ...
                                                    {
                                                      if(widget.billTextModel.serialMap.isNotEmpty){
                                                        widget.billTextModel.serialMap.add('Item${widget.billTextModel.serialMap.length} $value');
                                                      }
                                                      if(widget.billTextModel.serialMap.isEmpty){
                                                        widget.billTextModel.serialMap.insert(0 , 'Item0 $value');
                                                      }
                                                    }
                    ...
                    if(index == widget.billTextModel.serialMap.length-1){
                      return Container(
                        ...
                        child: Directionality(
                          textDirection: TextDirection.rtl,
                          child: TextFormField(
                            initialValue:widget.billTextModel.serialMap[index].contains('Item') ?
                            ...
                            decoration: InputDecoration(
                              ...
                              filled: true,
                              alignLabelWithHint: false,
                              label: Text((widget.billTextModel.serialMap[index].startsWith('Item'))?'اسم الصنف':'سيريال رقم ${index+1}',
                                style: TextStyle(fontWeight: FontWeight.bold ,
                                    color:widget.billTextModel.serialMap[index].startsWith('Item') ? Colors.black:
                                    Colors.black), textAlign: TextAlign.right,),
                              fillColor: widget.billTextModel.serialMap[index].startsWith('Item') ?Colors.green :
                            ...
                            onChanged: (value){
                              if(widget.billTextModel.serialMap[index].contains("Item")){
                                widget.billTextModel.serialMap[index]="Item ${value}";
                              }
                              if(!widget.billTextModel.serialMap[index].contains("Item")){
                            ...
                            onSaved: (v){
                              if(v!.isNotEmpty && v.length>0){
                                if(widget.billTextModel.serialMap[index].contains("Item")){
                                  widget.billTextModel.serialMap[index]="Item ${v}";
                                }
                                if(!widget.billTextModel.serialMap[index].contains("Item")){
